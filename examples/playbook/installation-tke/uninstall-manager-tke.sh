...
show_summary() {
    ...
    if [ "$SKIP_MANAGER_UNINSTALL" = "true" ]; then
        echo "   • Context: manager-admin-$MANAGER_CLUSTER_ID (preserved)"
    else
        echo "   • Context: manager-admin-$MANAGER_CLUSTER_ID (cleaned up)"
    fi
    ...
    echo ""
    echo "   • Check if ClusterBindings deleted:"
...
main() {
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "   🗑️  TKE Manager Cluster Uninstallation Script"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
