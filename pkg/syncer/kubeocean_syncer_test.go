...
func TestNewKubeoceanSyncer(t *testing.T) {
	...
	syncer, err := NewKubeoceanSyncer(fakeManager, fakeClient, scheme, "test-binding", 100, 150)
...
func TestKubeoceanSyncer_LoadClusterBinding(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
	...
	syncer, err := NewKubeoceanSyncer(nil, fakeClient, scheme, "test-binding", 100, 150)
...
func TestKubeoceanSyncer_LoadClusterBinding_NotFound(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
	...
	syncer, err := NewKubeoceanSyncer(nil, fakeClient, scheme, "nonexistent-binding", 100, 150)
	require.NoError(t, err)
...
func TestKubeoceanSyncer_ReadKubeconfigSecret(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			syncer, err := NewKubeoceanSyncer(nil, fakeClient, scheme, tt.binding.Name, 100, 150)
			require.NoError(t, err)
...
func TestKubeoceanSyncer_StopAndChannels(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
...
// TestKubeoceanSyncer_InitializeSyncers tests the syncer initialization
func TestKubeoceanSyncer_InitializeSyncers(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
...
// TestKubeoceanSyncer_PhysicalManagerLifecycle tests the physical manager lifecycle
func TestKubeoceanSyncer_PhysicalManagerLifecycle(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
...
// TestKubeoceanSyncer_GetClusterBinding tests the GetClusterBinding method
func TestKubeoceanSyncer_GetClusterBinding(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
...
// TestKubeoceanSyncer_ReadKubeconfigFromSecret tests reading kubeconfig from secret
func TestKubeoceanSyncer_ReadKubeconfigFromSecret(t *testing.T) {
	scheme := runtime.NewScheme()
	require.NoError(t, cloudv1beta1.AddToScheme(scheme))
	require.NoError(t, corev1.AddToScheme(scheme))
